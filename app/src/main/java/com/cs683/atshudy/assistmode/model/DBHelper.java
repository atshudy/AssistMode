...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_SILENT_TASK_STATE = "task_state";
    ...
    public static final String COLUMN_WIFI_TASK_STATE = "task_state";
    ...
    public static final String COLUMN_DRIVING_TASK_STATE = "task_state";
    ...
    private static final String SQL_CREATE_TABLE_SILENT_MODE = "CREATE TABLE " + TABLE_SILENT_MODE + "("
            ...
            + COLUMN_SILENT_TASK_STATE  + " INTEGER task_state"
            +");";
    ...
    private static final String SQL_CREATE_TABLE_WIFI_MODE = "CREATE TABLE " + TABLE_WIFI_MODE + "("
            ...
            + COLUMN_WIFI_TASK_STATE  + " INTEGER task_state"
            +");";
    ...
    private static final String SQL_CREATE_TABLE_DRIVING_MODE = "CREATE TABLE " + TABLE_DRIVING_MODE + "("
            ...
            + COLUMN_DRIVING_TASK_STATE  + " INTEGER task_state"
            +");";
