...
public class CustomListAdapter extends ArrayAdapter<Task> {
	...
	public CustomListAdapter(Context context, int layoutResourceId, ArrayList<Task> data) {
        ...
        void deleteTaskItem(Task Item, CustomListAdapter adapter) {
            ...
            switch (Item.getParentTab()){
                case  TAB_ONE:
                    ...
                    silentModeDAO = new SilentModeDAO(context);
                    try {
                ...
                case  TAB_TWO:
                    ...
                    wifiModeDAO = new WiFiModeDAO(context);
                    try {
                ...
                case  TAB_THREE:
                    ...
                    drivingModeDAO = new DrivingModeDAO(context);
                    try {
